# Table: ovh_cloud_project_usage_forecast

Retrieve forecasted usage and billing information for an OVHcloud Public Cloud project. This table provides predictive analytics for upcoming costs based on current resource consumption patterns.
...
| period_end | timestamp | End date of the forecast period |
| period_start | timestamp | Start date of the forecast period |
...
| total_price | double | Total forecasted price for the period |
| total_price_without_discount | double | Total forecasted price before any discounts applied |
